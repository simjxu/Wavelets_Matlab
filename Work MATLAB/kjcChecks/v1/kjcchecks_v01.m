function varargout = kjcchecks_v01(varargin)
global filename pathname tbox tbox2 refnum  bgfilename bgpathname gainoffset bggainoffset
% EJGCHECKS Application M-file for kjcchecks_v01.fig
%    FIG = EJGCHECKS launch kjcchecks_v01 GUI.
%    EJGCHECKS('callback_name', ...) invoke the named callback.

% Last Modified by GUIDE v2.5 26-Feb-2007 15:41:22
...
ejglook2_db_logx(filename,pathname,refnum,0)
...
[filename,pathname]=uigetfile('*_a.mat','Pick a set');
...
[bgfilename,bgpathname]=uigetfile('*_a.mat','Pick Background set');
...
%djmarrayth
global filename pathname bgfilename bgpathname gainoffset bggainoffset
ejglook5_db_logx(filename,pathname, bgfilename, bgpathname, gainoffset, bggainoffset)
...
ejglook4_db_logx(filename,pathname, refnum)
...
global filename pathname bgfilename bgpathname gainoffset bggainoffset refnum
ejglook6_db_logx(filename,pathname, refnum)
...
ejglook7_db_logx(filename,pathname,bgfilename,bgpathname,gainoffset,bggainoffset, refnum)
...
global filename pathname refnum
ejglook2_db_logx(filename,pathname,refnum,1)
